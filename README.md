...
| TF1     | 07/07/2025  | - Briceño De La Cruz, Farid<br>- Galvez Chambi, Jhon<br>- Guzman Chavez, Ramiro<br>- Muñoz Vilcapoma, Mauricio<br>- Perez Garcia, David | Para esta entrega final se han desarrollado los siguientes capítulos:<br>- Versión actualizada del Registro de Versiones del Informe y Sección Student Outcome<br>- Versión corregida y mejorada de artefactos previamente presentados<br>- Capítulo VIII: Experiment-Driven Development (completado)<br>&nbsp;&nbsp;- 8.3. Experimentation<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3. Pipeline-supported, Experiment-Driven To-Be Software Platform Lifecycle<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.1. To-Be Sprint Backlogs<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.2. Implemented To-Be Landing Page Evidence<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.3. Implemented To-Be Frontend-Web Application Evidence<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.4. Implemented To-Be Native-Mobile Application Evidence<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.5. Implemented To-Be RESTful API and/or Serverless Backend Evidence<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.3.6. Team Collaboration Insights<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.4. To-Be Validation Interviews<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.4.1. Diseño de Entrevistas<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 8.3.4.2. Registro de Entrevistas<br>&nbsp;&nbsp;- 8.4. Experiment Aftermath & Analysis<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.4.1. Analysis and Interpretation of Results<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.4.2. Re-scored and Re-prioritized Question Backlog<br>&nbsp;&nbsp;- 8.5. Continuous Learning<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.5.1. Shareback Session Artifacts: Learning Workflow<br>&nbsp;&nbsp;- 8.6. To-Be Software Platform Pre-launch<br>&nbsp;&nbsp;&nbsp;&nbsp;- 8.6.1. About-the-Product Intro Video<br>- Final Project Mid-term Documentation Report<br>- Final Project Mid-term Keynote<br>- Final Project Mid-Term Individual Member Performance Report (by Team Leader)<br>- Archivo .zip con archivos complementarios (videos, proyectos de software, documentos complementarios)<br>- Conclusiones finales, Bibliografía y Anexos |
...
|:-----------------------:|-------------------------|-------------------|
| **4.c.1**<br>Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software | **- Ramiro Guzman**<br>**TB1:** Como parte del equipo, me enfoqué en asegurar que todas las soluciones tecnológicas respetaran los principios éticos de privacidad y seguridad. Analicé y discutí las implicaciones éticas de cada decisión técnica para garantizar que nuestro proyecto no sólo fuera funcional, sino también responsable.<br>**TP1:** Revisé que las nuevas implementaciones respetaran los principios de confidencialidad y privacidad. Además, evalué la configuración de despliegue para evitar posibles vulnerabilidades en los entornos de producción.<br>**TB2:** Participé activamente en la auditoría de la experiencia del usuario, asegurándome de que el diseño respetara la equidad y accesibilidad para distintos perfiles de usuarios, incluyendo aquellos con discapacidades.<br>**TF1:** En la entrega final, lideré la implementación de experimentos éticos, garantizando que la recolección de datos de usuarios siguiera estrictos protocolos de consentimiento informado y anonimización. Aseguré que las métricas experimentales respetaran la dignidad y privacidad de los participantes.<br><br>**- Farid Briceño**<br>**TB1:** Durante este primer tramo del proyecto, me comprometí a entender y aplicar las mejores prácticas relacionadas con la seguridad de los usuarios y la confidencialidad de la información.<br>**TP1:** Me aseguré de que las pruebas unitarias e integradas fueran desarrolladas con principios de calidad ética, garantizando que los servicios no violaran estándares de equidad o inclusión.<br>**TB2:** Participé en la revisión estática del código, promoviendo buenas prácticas que eviten consecuencias negativas no intencionadas y fomenten una cultura de responsabilidad profesional.<br>**TF1:** Durante el desarrollo de la plataforma To-Be, implementé controles de calidad y seguridad que aseguraran la integridad de los datos experimentales. Promovié la transparencia en los algoritmos de recomendación para evitar sesgos discriminatorios en las sugerencias de rutinas y dietas.<br><br>**- Jhon Galvez**<br>**TB1:** Asimilé el código de conducta y la ética fundamentales para un desarrollador. Esto me impulsó a colaborar activamente en la recopilación de la información requerida para nuestra aplicación, con la meta clara de generar un impacto significativo en la salud y el bienestar de las personas.<br>**TP1:** Reflexioné sobre cómo nuestras decisiones técnicas podían afectar la salud mental de los usuarios. Con ello, propuse mejoras a la interfaz para minimizar sobrecargas cognitivas y promover una experiencia saludable.<br>**TB2:** Durante el diseño de entrevistas de validación, me aseguré de que las preguntas respetaran la privacidad del encuestado y promovieran una interacción ética entre usuario y sistema.<br>**TF1:** En la fase experimental, desarrollé protocolos de validación que priorizaran el bienestar psicológico de los usuarios participantes. Me aseguré de que los experimentos no generaran expectativas falsas o presión excesiva sobre los resultados de salud de los usuarios.<br><br>**- Mauricio Muñoz**<br>**TB1:** Contribuí al análisis de las necesidades del usuario y busqué formas en que la solución pudiera mejorar la calidad de vida sin comprometer valores fundamentales de privacidad y equidad.<br>**TP1:** Validé que la documentación técnica cumpliera con estándares de responsabilidad, revisando que las decisiones fueran transparentes y comunicadas de forma ética al equipo y stakeholders.<br>**TB2:** Evalué prácticas de monitoreo continuo, para que las alertas del sistema no invadieran la privacidad de los usuarios ni provocaran decisiones automatizadas no justificadas.<br>**TF1:** En el desarrollo final, implementé mecanismos de retroalimentación ética que permitieran a los usuarios controlar su participación en experimentos y acceder a información clara sobre cómo se utilizan sus datos para mejorar la plataforma. Establecí políticas de transparencia total en el manejo de información personal.<br><br>**- David Perez**<br>**TB1:** Trabajé en la implementación de medidas de accesibilidad y seguridad, entendiendo que los usuarios deben sentirse protegidos y respaldados en todo momento.<br>**TP1:** Me aseguré de que el backend cumpliera con los estándares de seguridad y tratara adecuadamente la gestión de datos sensibles.<br>**TB2:** Supervisé la auditoría recibida por otro grupo, garantizando una respuesta profesional y ética ante los hallazgos, priorizando la mejora continua con base en la retroalimentación.<br>**TF1:** Durante la implementación experimental, desarrollé sistemas de monitoreo ético que detectaran automáticamente posibles efectos adversos en los usuarios participantes. Implementé mecanismos de interrupción de experimentos si se detectaran riesgos para el bienestar de los usuarios, priorizando siempre la seguridad sobre los objetivos de investigación. | **TB1:** Cada miembro participó en sus actividades asignadas, manteniendo una comunicación activa y eficaz que fortaleció la confianza mutua. Esto mejoró el trabajo en equipo, un valor crucial para proyectos colaborativos.<br><br>**TP1:** En esta fase, el equipo reafirmó su compromiso ético mediante la aplicación de buenas prácticas de validación, pruebas y despliegue seguro. La discusión constante sobre implicancias éticas fortaleció el criterio técnico y la responsabilidad compartida.<br><br>**TB2:** La inclusión de auditorías, entrevistas y prácticas de monitoreo continuo permitió aplicar los principios éticos a un nivel avanzado, reafirmando el compromiso del equipo con la responsabilidad profesional, accesibilidad e integridad del producto.<br><br>**TF1:** En la entrega final, el equipo consolidó un marco de desarrollo ético-experimental que integró la responsabilidad profesional en cada fase del ciclo de vida del software. La implementación de experimentos controlados y la validación continua con usuarios reales demostró un compromiso maduro con la integridad, transparencia y bienestar de los usuarios como principios fundamentales del desarrollo de software. |
| **4.c.2**<br>Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales | **- Ramiro Guzman**<br>**TB1:** Evalué el impacto potencial de nuestra aplicación en distintos contextos. Consideré factores como la accesibilidad global y la sostenibilidad económica del proyecto.<br>**TP1:** Analicé los costos asociados al despliegue del software y su impacto en usuarios con recursos limitados. Promoví alternativas económicas para maximizar el alcance global.<br>**TB2:** Participé en la definición de indicadores de validación, considerando cómo nuestras decisiones podían beneficiar comunidades urbanas con problemas de salud pública y acceso limitado a tecnología.<br>**TF1:** En la fase experimental, evalué el impacto a largo plazo de nuestras decisiones de diseño en diferentes demografías globales. Consideré cómo los experimentos controlados podrían informar estrategias de escalabilidad que fueran culturalmente sensibles y económicamente viables en mercados emergentes.<br><br>**- Farid Briceño**<br>**TB1:** Me aseguré de que nuestras decisiones fueran informadas por un análisis exhaustivo del entorno global y las implicaciones sociales de la solución.<br>**TP1:** Evalué la inclusión de usuarios en zonas rurales, y sugerí funcionalidades que ampliaran el acceso a la plataforma desde dispositivos de gama baja.<br>**TB2:** Consideré el impacto ambiental de nuestras decisiones tecnológicas, optimizando recursos del servidor y prácticas de despliegue para reducir el consumo innecesario.<br>**TF1:** Durante la implementación experimental, desarrollé métricas de sostenibilidad que midieran no solo el éxito del producto sino también su huella ambiental y social. Propuse modelos de negocio que priorizaran el acceso equitativo a la salud digital, especialmente en comunidades con recursos limitados.<br><br>**- Jhon Galvez**<br>**TB1:** Considero que la propuesta que hemos concebido aborda la problemática de salud desde una perspectiva integral.<br>**TP1:** Reflexioné sobre cómo la solución podía integrarse en el estilo de vida urbano y propuse que el producto contemplara escalabilidad en diferentes ciudades del país.<br>**TB2:** Analicé los datos obtenidos en entrevistas y sugerí mejoras que alinearan la experiencia con las realidades sociales y económicas del público objetivo.<br>**TF1:** En los experimentos finales, diseñé validaciones que consideraran el impacto de FitWise en la reducción de desigualdades de salud. Evalué cómo la tecnología podría democratizar el acceso a herramientas de bienestar, midiendo su efectividad en diferentes contextos socioeconómicos y geográficos.<br><br>**- Mauricio Muñoz**<br>**TB1:** Consideré el impacto económico y social de las decisiones que tomamos, buscando siempre soluciones que fueran viables tanto económicamente como socialmente.<br>**TP1:** Analicé la viabilidad económica del backend, proponiendo soluciones con servicios gratuitos u open-source que reduzcan los costos a futuro.<br>**TB2:** Estudié la retroalimentación del grupo auditor y ajusté partes de la solución para asegurar su adaptabilidad en distintos contextos socioeconómicos.<br>**TF1:** En la entrega final, implementé sistemas de monitoreo que evaluaran el impacto económico de la plataforma en los hábitos de gasto de salud de los usuarios. Desarrollé indicadores que midieran cómo FitWise podría contribuir a la prevención de enfermedades crónicas, reduciendo costos de salud pública a largo plazo.<br><br>**- David Perez**<br>**TB1:** Me aseguré de que nuestras decisiones fueran lo más inclusivas posibles, considerando que el impacto de nuestro trabajo podría ir más allá de nuestras fronteras.<br>**TP1:** Evalué cómo la solución podía responder a problemáticas emergentes en la sociedad, como el estrés digital, proponiendo funcionalidades más amigables.<br>**TB2:** Participé en el diseño de experimentos, buscando medir el impacto social real de nuestras decisiones con métricas de bienestar y calidad de vida.<br>**TF1:** Durante la fase experimental, desarrollé protocolos de evaluación que midieran el impacto transformacional de FitWise en comunidades diversas. Analicé cómo los experimentos controlados podrían informar políticas de salud pública y contribuir al desarrollo de ecosistemas de bienestar digital más inclusivos y sostenibles a nivel global. | **TB1:** Cada miembro participó en sus actividades asignadas, manteniendo una comunicación activa y eficaz que fortaleció la confianza mutua. Esto mejoró el trabajo en equipo, un valor crucial para proyectos colaborativos.<br><br>**TP1:** El equipo avanzó en la toma de decisiones informadas, considerando el contexto de los usuarios y el entorno. Se priorizó el diseño accesible, el uso eficiente de recursos y el impacto social, reflejando madurez ética y técnica.<br><br>**TB2:** Las decisiones estuvieron guiadas por experimentación y retroalimentación. Se consolidó un enfoque de ingeniería responsable que valoró el impacto ambiental, la equidad y la adaptabilidad de la solución a diversos escenarios sociales.<br><br>**TF1:** En la entrega final, el equipo demostró una comprensión madura del impacto multidimensional de las soluciones de software. La implementación de experimentos controlados y la evaluación sistemática de resultados permitió tomar decisiones informadas que consideraron no solo la viabilidad técnica, sino también las implicaciones éticas, ambientales, económicas y sociales. El enfoque experimental facilitó la validación de hipótesis sobre el impacto real de FitWise en la promoción de la salud pública y la reducción de desigualdades de acceso al bienestar digital. |
...
<p align="center">
<img src="./assets/prototipoWeb.jpg" alt="prototipoWeb"/>
</p>
...
|----------------|-----------------|
| **Heurísticas de Usabilidad: Diseño estético y minimalista** | Tiene un diseño simple, lo que permite tener claro solo la información que se quiere mostrar. <br><br> <img src="./assets/heu1.png" alt="heu1" /> |
| **Heurísticas de Usabilidad: Consistencia entre el sistema y el mundo real** | Usa palabras simples que permiten al usuario encontrar lo que está buscando o responder de manera correcta en caso de querer enviar un mensaje usando contacto. Además, usa imágenes que son bastante entendidas por el público general. <br><br> <img src="./assets/heu2.png" alt="heu2" /> <img src="./assets/heu3.png" alt="heu3" /> |
| **Heurística de Usabilidad: Libertad y control por parte del usuario** | Los usuarios tienen acceso a poder dirigirse a cualquier sección que deseen usando los accesos directos del menú de navegación que está ubicado en el header. <br><br> <img src="./assets/heu2.png" alt="heu2" /> <br><br> Por parte de los usuarios en móvil también pueden moverse libremente usando el menú hamburguesa que te muestra varios accesos directos a diferentes secciones. <br><br> <img src="./assets/heu4.png" alt="heu4" /> <img src="./assets/heu5.png" alt="heu5" />
| **Heurística de Information Architecture: ¿Es accesible?** | Se puede acceder a la aplicación desde varios dispositivos, adaptándose a estos. <br><br> <img src="./assets/heu1.png" alt="heu1" /> <img src="./assets/heu6.png" alt="heu6" /> |
| **Principios de Inclusividad: Prioriza el contenido** | Destaca el contenido importante para el usuario evitando llenar las secciones de información no necesaria. <br><br>  <img src="./assets/heu7.png" alt="heu7" />|
